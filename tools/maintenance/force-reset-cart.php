...
echo "<h2>🔄 FORCE RESET CART - Xóa sạch và test lại</h2>";
...
try {
    ...
    echo "<p>Cart count sau khi reset: $cartCount</p>";
    ...
    // 6. Kiểm tra available_quantity calculation
    ...
    echo "<h3 style='color: green;'>✅ HOÀN THÀNH RESET!</h3>";
    ...
    echo "<p><strong>Nếu vẫn lỗi, có thể do:</strong></p>";
    echo "<ul>";
    echo "<li>Cache trình duyệt - Ctrl+F5 để hard refresh</li>";
    echo "<li>Session cũ - Đăng xuất và đăng nhập lại</li>";
    echo "<li>JavaScript cache - Xóa cache trình duyệt</li>";
    echo "</ul>";
