...
echo "<h1>🔥 ULTIMATE FIX QUANTITY - SỬA HOÀN TOÀN</h1>";
...
try {
    ...
    // 3. KIỂM TRA CART TABLE STRUCTURE
    echo "<h2>3. KIỂM TRA CART TABLE STRUCTURE</h2>";
    ...
    // 5. TẠO CART.PHP MỚI VỚI LOGIC FORCE FIX
    echo "<h2>5. TẠO CART.PHP MỚI VỚI LOGIC FORCE FIX</h2>";
...
<?php include \'includes/footer.php\'; ?>';
    ...
    // 6. KIỂM TRA LẠI CART
    echo "<h2>6. KIỂM TRA LẠI CART</h2>";
    $cartItems = Database::fetchAll("SELECT * FROM cart");
    echo "<pre>";
    print_r($cartItems);
    echo "</pre>";
    
    echo "<h1 style='color: green;'>✅ HOÀN THÀNH ULTIMATE FIX!</h1>";
