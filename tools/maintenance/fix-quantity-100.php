...
try {
    ...
    // 5. Test thêm item vào cart với quantity = 1
    echo "<h3>5. Test thêm item vào cart với quantity = 1:</h3>";
    ...
    echo "<h3>6. Kiểm tra available_quantity calculation:</h3>";
